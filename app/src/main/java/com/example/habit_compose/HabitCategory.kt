...
val habitCategories = listOf(
    ...
    HabitCategory("Don’t smoke", "Health", R.drawable.bc_cigratte, R.drawable.ciggrate, Color(0xFF29B6F6)),
    ...
    HabitCategory("Journaling", "Mindfulness", R.drawable.back_yoga, R.drawable.reading, Color(0xFF5C6BC0)),    HabitCategory("Sleep Early", "Health", R.drawable.sport_back, R.drawable.sleep, Color(0xFF26A69A)),
            ...
            LazyColumn(
                ...
                itemsIndexed(habitCategories) { index, habit ->
                    HabitCardStyled(habit = habit, index = index) {
                        navController.navigate("habit_form")
                    }
                }
            }
